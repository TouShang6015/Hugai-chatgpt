...
@Slf4j
@Component
public class RerollSuccessHandler extends MessageStrategyAbstract {
    ...
    protected MjStrategyTypeEnum getType() {
        return MjStrategyTypeEnum.RerollSuccess;
    }
    ...
    public void handle(MessageType messageType, DataObject message) {
        ...
        if (MessageType.CREATE.equals(messageType) && parseData != null && hasImage(message)) {
            ...
            log.debug("reroll success - prompt:{}", parseData.getPrompt());
        }
    }
