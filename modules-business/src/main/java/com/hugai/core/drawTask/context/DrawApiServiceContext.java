...
public class DrawApiServiceContext {
    ...
    public DrawApiService getDrawApiService() {
        ...
        switch (drawApiKey) {
            case openai_txt2img:
                drawApiService = new ApiStrategyOpenaiTxtImg(this.cacheService, this.drawData, this.cacheData);
                break;
            case openai_img2img:
                drawApiService = new ApiStrategyOpenaiImg2img(this.cacheService, this.drawData, this.cacheData);
                break;
            case sd_txt2img:
                drawApiService = new ApiStrategySdTxtImg(this.cacheService, this.drawData, this.cacheData);
                break;
            case sd_img2img:
                drawApiService = new ApiStrategySdImg2Img(this.cacheService, this.drawData, this.cacheData);
                break;
            case mj_txt2img:
                drawApiService = new ApiStrategyMjTxt2Img(this.cacheService, this.drawData);
                break;
            case mj_u:
                drawApiService = new ApiStrategyMjU(this.cacheService, this.drawData);
                break;
            case mj_v:
                drawApiService = new ApiStrategyMjV(this.cacheService, this.drawData);
                break;
            default:
