...
-- ----------------------------
INSERT INTO `base_resource_config` VALUES (102061615, NULL, NULL, '2023-07-20 10:18:41', '1000000000', 0, 12, 'main', '{\"maxUserLogin\":5,\"staticWebsite\":\"http://xxxxxxx.com\",\"website\":\"http://localhost:9000\",\"registerOpen\":true,\"authCodeOpen\":false,\"fileSaveStrategy\":\"qiniu\",\"proxyHost\":\"127.0.0.1\",\"proxyPort\":\"7890\",\"ableSystemApiKey\":false}');
INSERT INTO `base_resource_config` VALUES (112061615, NULL, NULL, '2023-07-10 14:07:16', '1000000000', 0, 0, 'openai', '{\"proxyHost\":\"127.0.0.1\",\"proxyPort\":\"7890\",\"chatModel\":\"gpt-3.5-turbo\",\"textModel\":\"text-davinci-003\"}');
...
CREATE TABLE `sys_logininfor`  (
  ...
  `msg` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提示消息',
  `login_time` datetime NULL DEFAULT NULL COMMENT '访问时间',
  `login_type` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登陆类型 0 系统用户 1 普通用户',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_permission` VALUES (1674578728694370305, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582491907805185, '0,1674579384591241218,1674582491907805185', 'sysRoleController', '角色信息', 'selectAuthUserAll', '/module/system/sysrole/authUser/selectAll', '/module/system/sysrole/authUser/selectAll', 'module:system:sysrole:authUser:selectAll', 'PUT', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578728694370306, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582439277678594, '0,1674579384591241218,1674582439277678594', 'loginPcController', '登陆控制器', 'register', '/auth/system/register', '/auth/system/register', 'auth:system:register', 'POST', 1, 3);
...
INSERT INTO `sys_permission` VALUES (1674578728761479181, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582439277678594, '0,1674579384591241218,1674582439277678594', 'loginPcController', '登陆控制器', 'info', '/auth/system/info', '/auth/system/info', 'auth:system:info', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578728761479182, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674580927755374593, '0,1674578853248421890,1674580927755374593', 'sysUserController', '用户信息', 'insertAuthRole', '/module/system/sysuser/insertAuthRole', '/module/system/sysuser/insertAuthRole', 'module:system:sysuser:insertAuthRole', 'PUT', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1674578728828588055, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674578906511888386, '0,1674578906511888386', 'apiResourceController', '', 'securityConfiguration', '/swagger-resources/configuration/security', '/swagger-resources/configuration/security', 'swagger-resources:configuration:security', '', 1, 3);
INSERT INTO `sys_permission` VALUES (1674578728828588056, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582818715389954, '0,1674580535470510082,1674582818715389954', 'resourceConfigController', '系统参数配置', 'baseQueryById', '/module/system/baseresourceconfig/baseQueryById/{id}', '/module/system/baseresourceconfig/baseQueryById/*', 'module:system:baseresourceconfig:baseQueryById:*', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578728828588057, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582818715389954, '0,1674580535470510082,1674582818715389954', 'resourceConfigController', '系统参数配置', 'queryByConfigKey', '/module/system/baseresourceconfig/queryByConfigKey/{configKey}', '/module/system/baseresourceconfig/queryByConfigKey/*', 'module:system:baseresourceconfig:queryByConfigKey:*', 'GET', 1, 3);
INSERT INTO `sys_permission` VALUES (1674578728828588058, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674579708391510017, '0,1674578906511888386,1674579708391510017', 'commonController', '通用控制器', 'getEnumLabel', '/common/getEnumLabel/{key}', '/common/getEnumLabel/*', 'common:getEnumLabel:*', 'GET', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1674578728828588074, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674583544443228161, '0,1674579089589063681,1674583544443228161', 'sessionRecordController', '会话详情', 'getPageRecordSession', '/module/session/sessionrecord/getPageRecordSession', '/module/session/sessionrecord/getPageRecordSession', 'module:session:sessionrecord:getPageRecordSession', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578728828588075, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674581814276050945, '0,1674579114499035137,1674581814276050945', 'sysJobLogController', '定时任务调度日志表', 'clean', '/module/quartz/sysjoblog/clean', '/module/quartz/sysjoblog/clean', 'module:quartz:sysjoblog:clean', 'DELETE', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1674578728828588081, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674579841480970241, '0,1674578906511888386,1674579841480970241', 'sysJobController', '定时任务调度表', 'run', '/module/quartz/sysjob/run', '/module/quartz/sysjob/run', 'module:quartz:sysjob:run', 'PUT', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578728828588082, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674581645400788994, '0,1674579089589063681,1674581645400788994', 'sessionInfoController', '会话表', 'clearSession', '/module/session/sessioninfo/clearSession/{sessionId}', '/module/session/sessioninfo/clearSession/*', 'module:session:sessioninfo:clearSession:*', 'GET', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1674578729529036810, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674580956448608258, '0,1674578853248421890,1674580956448608258', 'userInfoController', '用户控制器', 'baseQueryPageByParam', '/module/user/userinfo/baseQueryPageByParam', '/module/user/userinfo/baseQueryPageByParam', 'module:user:userinfo:baseQueryPageByParam', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729612922882, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582505417658369, '0,1674579384591241218,1674582505417658369', 'sysMenuController', '菜单权限', 'baseAdd', '/module/system/sysmenu/baseAdd', '/module/system/sysmenu/baseAdd', 'module:system:sysmenu:baseAdd', 'POST', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1674578729663254535, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582491907805185, '0,1674579384591241218,1674582491907805185', 'sysRoleController', '角色信息', 'baseQueryByParam', '/module/system/sysrole/baseQueryByParam', '/module/system/sysrole/baseQueryByParam', 'module:system:sysrole:baseQueryByParam', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729663254536, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582790324146177, '0,1674580535470510082,1674582790324146177', 'baseDictDataController', '字典数据', 'optionSelect', '/module/system/basedictdata/optionSelect/{dictType}', '/module/system/basedictdata/optionSelect/*', 'module:system:basedictdata:optionSelect:*', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729663254537, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582466536460289, '0,1674579384591241218,1674582466536460289', 'sysPermissionController', '权限管理', 'baseEdit', '/module/system/syspermission/baseEdit', '/module/system/syspermission/baseEdit', 'module:system:syspermission:baseEdit', 'PUT', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729663254538, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674579182287376385, '0,1674578853248421890,1674579182287376385', 'sysUserOnlineController', '在线用户监控', 'baseQueryByParam', '/module/system/monitor/online/baseQueryByParam', '/module/system/monitor/online/baseQueryByParam', 'module:system:monitor:online:baseQueryByParam', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729663254539, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582818715389954, '0,1674580535470510082,1674582818715389954', 'resourceConfigController', '系统参数配置', 'baseDeleteByIds', '/module/system/baseresourceconfig/baseDeleteByIds/{ids}', '/module/system/baseresourceconfig/baseDeleteByIds/*', 'module:system:baseresourceconfig:baseDeleteByIds:*', 'DELETE', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578729663254541, '2023-06-30 08:40:55', NULL, '2023-06-30 08:40:55', '1000000000', 0, 0, 1674582505417658369, '0,1674579384591241218,1674582505417658369', 'sysMenuController', '菜单权限', 'baseQueryByParam', '/module/system/sysmenu/baseQueryByParam', '/module/system/sysmenu/baseQueryByParam', 'module:system:sysmenu:baseQueryByParam', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1674578853248421890, '2023-06-30 08:41:25', '1000000000', '2023-06-30 08:41:25', '1000000000', 0, 0, 0, '0', '用户', '用户', '用户', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674578906511888386, '2023-06-30 08:41:38', '1000000000', '2023-06-30 08:41:38', '1000000000', 0, 0, 0, '0', '其他', '其他', '其他', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579089589063681, '2023-06-30 08:42:21', '1000000000', '2023-06-30 08:42:21', '1000000000', 0, 0, 0, '0', '客户端会话', '客户端会话', '客户端会话', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579114499035137, '2023-06-30 08:42:27', '1000000000', '2023-06-30 08:42:27', '1000000000', 0, 0, 0, '0', '日志', '日志', '日志', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579182287376385, '2023-06-30 08:42:43', '1000000000', '2023-06-30 08:42:43', '1000000000', 0, 0, 1674578853248421890, '0,1674578853248421890', '在线用户监控', '在线用户监控', '在线用户监控', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579384591241218, '2023-06-30 08:43:32', '1000000000', '2023-06-30 08:43:32', '1000000000', 0, 0, 0, '0', '权限', '权限', '权限', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579708391510017, '2023-06-30 08:44:49', '1000000000', '2023-06-30 08:44:49', '1000000000', 0, 0, 1674578906511888386, '0,1674578906511888386', '通用', '通用', '通用', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674579841480970241, '2023-06-30 08:45:21', '1000000000', '2023-06-30 08:45:21', '1000000000', 0, 0, 1674578906511888386, '0,1674578906511888386', '定时任务', '定时任务', '定时任务', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674580535470510082, '2023-06-30 08:48:06', '1000000000', '2023-06-30 08:48:06', '1000000000', 0, 0, 0, '0', '系统', '系统', '系统', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674580927755374593, '2023-06-30 08:49:40', '1000000000', '2023-06-30 08:49:40', '1000000000', 0, 0, 1674578853248421890, '0,1674578853248421890', '系统用户', '系统用户', '系统用户', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674580956448608258, '2023-06-30 08:49:46', '1000000000', '2023-06-30 08:49:46', '1000000000', 0, 0, 1674578853248421890, '0,1674578853248421890', '客户端用户', '客户端用户', '客户端用户', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674581584893759489, '2023-06-30 08:52:16', '1000000000', '2023-06-30 08:52:16', '1000000000', 0, 0, 1674579089589063681, '0,1674579089589063681', '消息发送', '消息发送', '消息发送', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674581645400788994, '2023-06-30 08:52:31', '1000000000', '2023-06-30 08:52:31', '1000000000', 0, 0, 1674579089589063681, '0,1674579089589063681', '会话管理', '会话管理', '会话管理', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674581814276050945, '2023-06-30 08:53:11', '1000000000', '2023-06-30 08:53:11', '1000000000', 0, 0, 1674579114499035137, '0,1674579114499035137', '定时任务日志', '定时任务日志', '定时任务日志', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674581849239769090, '2023-06-30 08:53:19', '1000000000', '2023-06-30 08:53:19', '1000000000', 0, 0, 1674579114499035137, '0,1674579114499035137', '操作记录日志', '操作记录日志', '操作记录日志', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674581892462071809, '2023-06-30 08:53:30', '1000000000', '2023-06-30 08:53:30', '1000000000', 0, 0, 1674579114499035137, '0,1674579114499035137', '访问日志', '访问日志', '访问日志', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582439277678594, '2023-06-30 08:55:40', '1000000000', '2023-06-30 08:55:40', '1000000000', 0, 0, 1674579384591241218, '0,1674579384591241218', '管理员登陆', '管理员登陆', '管理员登陆', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582466536460289, '2023-06-30 08:55:46', '1000000000', '2023-06-30 08:55:46', '1000000000', 0, 0, 1674579384591241218, '0,1674579384591241218', '接口权限', '接口权限', '接口权限', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582491907805185, '2023-06-30 08:55:52', '1000000000', '2023-06-30 08:55:52', '1000000000', 0, 0, 1674579384591241218, '0,1674579384591241218', '角色', '角色', '角色', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582505417658369, '2023-06-30 08:55:56', '1000000000', '2023-06-30 08:55:56', '1000000000', 0, 0, 1674579384591241218, '0,1674579384591241218', '菜单', '菜单', '菜单', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582790324146177, '2023-06-30 08:57:04', '1000000000', '2023-06-30 08:57:04', '1000000000', 0, 0, 1674580535470510082, '0,1674580535470510082', '字典', '字典', '字典', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582818715389954, '2023-06-30 08:57:10', '1000000000', '2023-06-30 08:57:10', '1000000000', 0, 0, 1674580535470510082, '0,1674580535470510082', '系统参数', '系统参数', '系统参数', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674582856791281665, '2023-06-30 08:57:19', '1000000000', '2023-06-30 08:57:19', '1000000000', 0, 0, 1674580535470510082, '0,1674580535470510082', 'apikeys', 'apikeys', 'apikeys', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674583544443228161, '2023-06-30 09:00:03', '1000000000', '2023-06-30 09:00:03', '1000000000', 0, 0, 1674579089589063681, '0,1674579089589063681', '会话记录', '会话记录', '会话记录', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674583564886265858, '2023-06-30 09:00:08', '1000000000', '2023-06-30 09:00:08', '1000000000', 0, 0, 1674579089589063681, '0,1674579089589063681', '领域会话', '领域会话', '领域会话', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1674622533179109377, '2023-06-30 11:34:59', NULL, '2023-06-30 11:34:59', '1000000000', 0, 0, 1674579708391510017, '0,1674578906511888386,1674579708391510017', 'commonController', '通用下载', 'download', '/common/download', '/common/download', 'common:download', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1674622533200080898, '2023-06-30 11:34:59', NULL, '2023-06-30 11:34:59', '1000000000', 0, 0, 1674579708391510017, '0,1674578906511888386,1674579708391510017', 'commonController', '文件上传', 'upload', '/common/upload', '/common/upload', 'common:upload', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1675013065540587522, '2023-07-01 13:26:49', NULL, '2023-07-01 13:26:49', '1000000000', 0, 0, 1674579708391510017, '0,1674578906511888386,1674579708391510017', 'commonController', '通用控制器', 'uploadImage', '/common/uploadImage', '/common/uploadImage', 'common:uploadImage', 'POST', 1, 1);
...
INSERT INTO `sys_permission` VALUES (1676790579284992001, '2023-07-06 11:10:02', '1000000000', '2023-07-06 11:10:02', '1000000000', 0, 0, 1674580535470510082, '0,1674580535470510082', '文件配置', '文件配置', '文件配置', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1676790618824695810, '2023-07-06 11:10:11', NULL, '2023-07-06 11:10:11', '1000000000', 0, 0, 1674580956448608258, '0,1674578853248421890,1674580956448608258', 'userInfoController', '用户控制器', 'getUserGrants', '/module/user/userinfo/getUserGrants', '/module/user/userinfo/getUserGrants', 'module:user:userinfo:getUserGrants', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1676790618824695811, '2023-07-06 11:10:11', NULL, '2023-07-06 11:10:11', '1000000000', 0, 0, 1674581584893759489, '0,1674579089589063681,1674581584893759489', 'sseController', 'sse通用请求控制器', 'connect', '/sse/connect', '/sse/connect', 'sse:connect', 'GET', 1, 3);
INSERT INTO `sys_permission` VALUES (1677188224147001346, '2023-07-07 13:30:07', NULL, '2023-07-07 13:30:07', '1000000000', 0, 0, 1674580956448608258, '0,1674578853248421890,1674580956448608258', 'userInfoController', '用户修改桌面背景', 'editUserBackground', '/module/user/userinfo/editUserBackground', '/module/user/userinfo/editUserBackground', 'module:user:userinfo:editUserBackground', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122745708546, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674582856791281665, '0,1674580535470510082,1674582856791281665', 'openaiKeysController', 'apikeys', 'delUserApiKey', '/module/config/openaikeys/delUserApiKey/{id}', '/module/config/openaikeys/delUserApiKey/*', 'module:config:openaikeys:delUserApiKey:*', 'DELETE', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623105, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674581645400788994, '0,1674579089589063681,1674581645400788994', 'sessionInfoController', '会话表', 'addDrawSession', '/module/session/sessioninfo/addDrawSession', '/module/session/sessioninfo/addDrawSession', 'module:session:sessioninfo:addDrawSession', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623106, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674582856791281665, '0,1674580535470510082,1674582856791281665', 'openaiKeysController', 'apikeys', 'addUserApiKey', '/module/config/openaikeys/addUserApiKey', '/module/config/openaikeys/addUserApiKey', 'module:config:openaikeys:addUserApiKey', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623107, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1684019553161465857, '0,1674580535470510082,1684019553161465857', 'captchaController', '验证码校验', 'check', '/captcha/check', '/captcha/check', 'captcha:check', 'POST', 1, 3);
INSERT INTO `sys_permission` VALUES (1683755122808623108, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1683755420184776705, '0,1674579089589063681,1683755420184776705', 'drawOpenaiController', '绘画控制器（openai）', 'sendAiDraw', '/module/draw/openai/sendAiDraw', '/module/draw/openai/sendAiDraw', 'module:draw:openai:sendAiDraw', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623109, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674583544443228161, '0,1674579089589063681,1674583544443228161', 'sessionRecordController', '会话详情获取单个会话信息', 'getLastOneRecordSession', '/module/session/sessionrecord/getLastOneRecordSession', '/module/session/sessionrecord/getLastOneRecordSession', 'module:session:sessionrecord:getLastOneRecordSession', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623110, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674580956448608258, '0,1674578853248421890,1674580956448608258', 'userInfoController', '用户控制器注册验证码发送', 'registerSendMail', '/module/user/userinfo/registerSendMail', '/module/user/userinfo/registerSendMail', 'module:user:userinfo:registerSendMail', 'GET', 1, 3);
INSERT INTO `sys_permission` VALUES (1683755122808623112, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674581584893759489, '0,1674579089589063681,1674581584893759489', 'chatController', '聊天会话控制器', 'send', '/module/chat/send', '/module/chat/send', 'module:chat:send', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623113, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674582856791281665, '0,1674580535470510082,1674582856791281665', 'openaiKeysController', 'apikeys', 'updateUserApiKey', '/module/config/openaikeys/updateUserApiKey', '/module/config/openaikeys/updateUserApiKey', 'module:config:openaikeys:updateUserApiKey', 'PUT', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623114, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674581584893759489, '0,1674579089589063681,1674581584893759489', 'chatController', '聊天会话控制器', 'sendDomain', '/module/chat/sendDomain', '/module/chat/sendDomain', 'module:chat:sendDomain', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623115, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674582856791281665, '0,1674580535470510082,1674582856791281665', 'openaiKeysController', 'apikeys', 'getUserApiKeys', '/module/config/openaikeys/getUserApiKeys', '/module/config/openaikeys/getUserApiKeys', 'module:config:openaikeys:getUserApiKeys', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623116, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1683755420184776705, '0,1674579089589063681,1683755420184776705', 'drawOpenaiController', '绘画控制器（openai）', 'sendAiDrawEdit', '/module/draw/openai/sendAiDrawEdit', '/module/draw/openai/sendAiDrawEdit', 'module:draw:openai:sendAiDrawEdit', 'POST', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755122808623117, '2023-07-25 16:24:38', NULL, '2023-07-25 16:24:38', '1000000000', 0, 0, 1674581645400788994, '0,1674579089589063681,1674581645400788994', 'sessionInfoController', '会话表', 'userLastDrawSession', '/module/session/sessioninfo/userLastDrawSession', '/module/session/sessioninfo/userLastDrawSession', 'module:session:sessioninfo:userLastDrawSession', 'GET', 1, 1);
INSERT INTO `sys_permission` VALUES (1683755420184776705, '2023-07-25 16:25:49', '1000000000', '2023-07-25 16:25:49', '1000000000', 0, 0, 1674579089589063681, '0,1674579089589063681', '绘图会话管理', '绘图会话管理', '绘图会话管理', '0', NULL, NULL, NULL, 0, NULL);
INSERT INTO `sys_permission` VALUES (1684018183868010497, '2023-07-26 09:49:57', NULL, '2023-07-26 09:49:57', '1000000000', 0, 0, 1684019553161465857, '0,1674580535470510082,1684019553161465857', 'captchaController', '验证码获取', 'get', '/captcha/get', '/captcha/get', 'captcha:get', 'POST', 1, 3);
INSERT INTO `sys_permission` VALUES (1684019553161465857, '2023-07-26 09:55:23', '1000000000', '2023-07-26 09:55:23', '1000000000', 0, 0, 1674580535470510082, '0,1674580535470510082', '验证码', '验证码', '验证码', '0', NULL, NULL, NULL, 0, NULL);
...
CREATE TABLE `tb_user_info`  (
  ...
  `status` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '帐号状态（0正常 1停用）',
